<?php
/**
 * @package THANHPHATPRO (tester)
 * @author  Lê Nguyễn Thành Phát <www.facebok.com/Thanh.Phat.203>
 */
interface ThanhDieuConfigInterface {
    public function CommonMethod();
}
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Lê Nguyễn Thành Phát   | Resources V5";
    public $description = "Hi my name is Thành Phát / A freelance / web developer / vexer";
    ...
    public $namesite = "THANHPHAT | HOME";
    ...
    public $SocialNetworks = [
        "facebook" => "https://facebook.com/Thanh.Phat.203", // Thay link facebook
        "instagram" => "https://www.instagram.com/phat.203", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/", // Thay link tiktok
        "telegram" => "https://t.me/thanhphatpro" // Thay link telegram
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Thành Phát", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Thúy Phương", // Thay tên đối phương
        //========================================================//
